    ...
    <div className="p-6">
      ...
      <div className="flex space-x-2 border-b mb-4">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-t-lg ${
            tab === "master" ? "bg-blue-600 text-white" : "bg-gray-100"
          }`}
        >
          Mata Kuliah
        </button>
      ...
      {tab === "master" && (
        <div className="bg-white shadow-md rounded-lg p-4">
          ...
          <table className="w-full border">
            ...
            <tbody>
              {mataKuliah.map((master, i) => (
                <tr key={i} className="hover:bg-gray-50">
                  <td className="border px-3 py-2">{master.kode}</td>
                  <td className="border px-3 py-2">{master.nama}</td>
                  <td className="border px-3 py-2">{master.sks}</td>
